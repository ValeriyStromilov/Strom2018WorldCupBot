...
load_dotenv('key.env')
bot_key = os.getenv('CHATGPT_API_KEY')

CATEGORY_TITLE = "Category:2018 FIFA World Cup"
...
def titles_from_category(
    ...
    """Возвращает набор заголовков страниц в данной категории Википедии и её подкатегориях."""
...
#Инициализация объекта MediaWiki, ссылка на англоязычную википедию
...
SAVE_PATH = "world_cup_2018_data.csv"
